...
public class LPQueryAnnotator extends JCasAnnotator_ImplBase {
  ...
  public void initialize(UimaContext aContext) throws ResourceInitializationException {
    ...
    String content = getFileAsStream((String) aContext.getConfigParameterValue(PARAM_STOP_WORD_FILE));
  ...
  public void process(JCas aJCas) throws AnalysisEngineProcessException {
    ...
    if (iter.isValid() && iter.hasNext()) {
      ...
      Tokenizer tokenizer = mTokenizerFactory.tokenizer(queString.toCharArray(), 0, queString.length());
